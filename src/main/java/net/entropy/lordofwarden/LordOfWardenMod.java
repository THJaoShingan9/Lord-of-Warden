package net.entropy.lordofwarden;
...
@Mod("lord_of_warden")
public class LordOfWardenMod {
	public static final Logger LOGGER = LogManager.getLogger(LordOfWardenMod.class);
	public static final String MODID = "lord_of_warden";

	public LordOfWardenMod() {
